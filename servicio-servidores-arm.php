...
<div class="applications-section sp bg-light">
  <div class="container">
    <div class="section-title text-center">
      <h2><?php echo __('servidores_arm_aplicaciones_titulo'); ?></h2>
      <p><?php echo __('servidores_arm_aplicaciones_subtitulo'); ?></p>
    </div>
    ...
    <div class="row">
      <div class="col-md-4 mb-4">
        <div class="app-card">
          ...
          <h4><?php echo __('servidores_arm_app1_titulo'); ?></h4>
          <p><?php echo __('servidores_arm_app1_desc'); ?></p>
        </div>
      </div>
      <div class="col-md-4 mb-4">
        <div class="app-card">
          <div class="icon"><i class="fas fa-cloud"></i></div>
          <h4><?php echo __('servidores_arm_app2_titulo'); ?></h4>
          <p><?php echo __('servidores_arm_app2_desc'); ?></p>
        </div>
      </div>
      <div class="col-md-4 mb-4">
        <div class="app-card">
          <div class="icon"><i class="fas fa-brain"></i></div>
          <h4><?php echo __('servidores_arm_app3_titulo'); ?></h4>
          <p><?php echo __('servidores_arm_app3_desc'); ?></p>
        </div>
      </div>
      <div class="col-md-4 mb-4">
        <div class="app-card">
          <div class="icon"><i class="fas fa-database"></i></div>
          <h4><?php echo __('servidores_arm_app4_titulo'); ?></h4>
          <p><?php echo __('servidores_arm_app4_desc'); ?></p>
        </div>
      </div>
      <div class="col-md-4 mb-4">
        <div class="app-card">

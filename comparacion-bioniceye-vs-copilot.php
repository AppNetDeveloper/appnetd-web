...
$page_meta = [
    'title' => 'BionicEyE vs asistentes IA genéricos',
    'description' => 'Comparativa funcional: BionicEyE multi-agente local vs asistentes IA cloud genéricos. Privacidad, coste, especialización.',
...
<section class="re-section">
    <div class="re-container">
        <article class="re-legal">
            ...
            <h1 class="re-display" style="font-family:'Space Grotesk',system-ui,sans-serif;font-size:var(--re-text-3xl);letter-spacing:-0.03em;line-height:1.1;margin-bottom:var(--re-space-3);background:linear-gradient(120deg, var(--re-ink) 0%, var(--re-iris-bright) 100%);-webkit-background-clip:text;background-clip:text;color:transparent;">BionicEyE vs asistentes IA genéricos</h1>
            <p style="font-size:var(--re-text-lg);color:var(--re-ink);line-height:1.55;border-left:3px solid var(--re-iris-bright);padding-left:var(--re-space-3);margin-bottom:var(--re-space-5);">Comparativa funcional: BionicEyE multi-agente local vs asistentes IA cloud genéricos. Privacidad, coste, especialización.</p>

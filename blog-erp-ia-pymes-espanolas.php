...
$page_meta = [
    'title' => 'ERP con IA para PYMEs españolas · Blog',
    'description' => 'VeriFactu AEAT, modelos 303/347/390, PGC doble partida: la automatización fiscal que exige la ley.',
...
<section class="re-section">
    <div class="re-container">
        <article class="re-legal">
            ...
            <h1 class="re-display" style="font-family:'Space Grotesk',system-ui,sans-serif;font-size:var(--re-text-3xl);letter-spacing:-0.03em;line-height:1.1;margin-bottom:var(--re-space-3);background:linear-gradient(120deg, var(--re-ink) 0%, var(--re-iris-bright) 100%);-webkit-background-clip:text;background-clip:text;color:transparent;">ERP con IA para PYMEs españolas · Blog</h1>
            <p style="font-size:var(--re-text-lg);color:var(--re-ink);line-height:1.55;border-left:3px solid var(--re-iris-bright);padding-left:var(--re-space-3);margin-bottom:var(--re-space-5);">VeriFactu AEAT, modelos 303/347/390, PGC doble partida: la automatización fiscal que exige la ley.</p>

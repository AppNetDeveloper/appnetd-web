...
if ($current_page === 'index') {
    ...
    $bioniceye_schema = [
        ...
        'description' => 'Oficina Virtual Inteligente con 8 agentes IA especializados (ADRI): Supervisor (ADRI), Browser, Code Orchestrator, Vision, Messaging, Social Media, Data Analysis y Planner. Gestiona navegación web, generación de código, OCR/visión, CRM multicanal, búsqueda web, redes sociales, análisis de datos, planificación, razonamiento avanzado y seguridad/compliance.',
        ...
        'featureList' => [
            '8 agentes IA especializados (ADRI)',
            'Supervisor (ADRI): Orquestación y coordinación de todos los agentes',
            'Browser: Navegación web y extracción de información',
            'Code Orchestrator: Generación, depuración y orquestación de código',
            'Vision: OCR de facturas/documentos e inspección visual',
            'Messaging: CRM multicanal (WhatsApp, Telegram, Email) 24/7',
            'Web Search: Investigación competitiva y monitorización de mercado',
            'Social Media: Gestión automatizada de redes sociales',
            'Data Analysis: Business Intelligence y análisis predictivo',
            'Planner: Planificación y optimización de recursos',
            'Deep Thinking: Razonamiento avanzado y resolución de problemas complejos',
            'OSINT/Security: Compliance legal, GDPR, AI Act y seguridad',

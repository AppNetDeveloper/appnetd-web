...
$page_meta = [
    'title' => 'IoT · Servicio',
    'description' => 'Solución IoT completa: sensores, conectividad, cloud o on-premise, dashboards, alertas.',
...
<section class="re-section">
    <div class="re-container">
        <article class="re-legal">
            ...
            <p style="font-size:var(--re-text-lg);color:var(--re-ink);line-height:1.55;border-left:3px solid var(--re-iris-bright);padding-left:var(--re-space-3);margin-bottom:var(--re-space-5);">Solución IoT completa: sensores, conectividad, cloud o on-premise, dashboards, alertas.</p>

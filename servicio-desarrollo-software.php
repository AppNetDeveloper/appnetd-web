...
$page_meta = [
    'title' => 'Desarrollo de software · Servicio',
    'description' => 'Software a medida en Laravel, Python, Node.js. PostgreSQL con pgvector. APIs + SPAs.',

...
.team-overlay {
    ...
    width: 100%;
    height: 100%;
    background: linear-gradient(180deg, transparent 0%, rgba(78, 84, 200, 0.9) 100%);
    display: flex;
...
<!-- Sección de Equipo Modernizada -->
<section class="team-modern py-5 bg-light">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mx-auto text-center mb-5" data-aos="fade-up" data-aos-duration="800">
                <div class="section-header">
                    <div class="section-badge">
                        <span><?php echo __('about_team_title'); ?></span>
                    </div>
                    <h2 class="section-title"><?php echo __('about_team_title'); ?></h2>
                    <p class="section-description"><?php echo __('about_team_subtitle'); ?></p>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-duration="600">
                <div class="team-card-modern">
                    <div class="team-image">
                        <img src="assets/img/team/member1.jpg" alt="<?php echo __('about_team_member1_role'); ?>" class="img-fluid">
                    ...
                    <div class="team-content">
                        <h4><?php echo __('about_team_member1_name'); ?></h4>
                        <span><?php echo __('about_team_member1_role'); ?></span>
                        <p><?php echo __('about_team_member1_desc'); ?></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-duration="700" data-aos-delay="100">
                <div class="team-card-modern">
                    <div class="team-image">
                        <img src="assets/img/team/member2.jpg" alt="<?php echo __('about_team_member2_role'); ?>" class="img-fluid">
                        <div class="team-overlay">
                            <div class="team-social">
                                <a href="#" aria-label="LinkedIn"><i class="fab fa-linkedin-in"></i></a>
                                <a href="#" aria-label="Twitter"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="team-content">
                        <h4><?php echo __('about_team_member2_name'); ?></h4>
                        <span><?php echo __('about_team_member2_role'); ?></span>
                        <p><?php echo __('about_team_member2_desc'); ?></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
                <div class="team-card-modern">
                    <div class="team-image">
                        <img src="assets/img/team/member3.jpg" alt="<?php echo __('about_team_member3_role'); ?>" class="img-fluid">
                        <div class="team-overlay">
                            <div class="team-social">
                                <a href="#" aria-label="LinkedIn"><i class="fab fa-linkedin-in"></i></a>
                                <a href="#" aria-label="Twitter"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="team-content">
                        <h4><?php echo __('about_team_member3_name'); ?></h4>
                        <span><?php echo __('about_team_member3_role'); ?></span>
                        <p><?php echo __('about_team_member3_desc'); ?></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-duration="900" data-aos-delay="300">
                <div class="team-card-modern">
                    <div class="team-image">
                        <img src="assets/img/team/member4.jpg" alt="<?php echo __('about_team_member4_role'); ?>" class="img-fluid">
                        <div class="team-overlay">
                            <div class="team-social">
                                <a href="#" aria-label="LinkedIn"><i class="fab fa-linkedin-in"></i></a>
                                <a href="#" aria-label="Twitter"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="team-content">
                        <h4><?php echo __('about_team_member4_name'); ?></h4>
                        <span><?php echo __('about_team_member4_role'); ?></span>
                        <p><?php echo __('about_team_member4_desc'); ?></p>
                    </div>
                </div>
            </div>
        </div>
